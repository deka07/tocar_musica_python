...
class App:
    ...
    def folder(self, *args):
        ...
        self.play_list.selection_set(0)
        self.play_list.bind("<Double-Button-1>", self.OnSelect) # Dois click para seleciona um item da lista
    ...
    def OnSelect(self, event):
        widget = event.widget
        self.musica = widget.get(widget.curselection()[0])
        print(self.musica)
